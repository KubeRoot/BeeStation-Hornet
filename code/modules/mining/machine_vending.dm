...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list( //if you add something to this, please, for the love of god, sort it by price/type. use tabs and not spaces.
		...
		new /datum/data/mining_equipment("Deepcore Pinpointer",			/obj/item/pinpointer/deepcore,										200),		// WS edit - Deepcore
		new /datum/data/mining_equipment("Advanced Deepcore Pinpointer",/obj/item/pinpointer/deepcore/advanced,								800),		// WS edit - Deepcore
		new /datum/data/mining_equipment("Drill Deployment Capsule",	/obj/item/deepcorecapsule,											800),		// WS edit - Deepcore
